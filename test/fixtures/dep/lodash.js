 ...
 * Build: `lodash backbone category="collections,functions" exports="amd,commonjs,node" iife="!function(window,undefined){%output%}(this)" include="each,filter,map" minus="result,shuffle" plus="random,template" settings="{interpolate:/\{\{([\s\S]+?)\}\}/g}" --output tmp/dep/lodash.js`
